...
InjectWebpackPlugin.prototype.apply = function(compiler) {
  ...
  this.filesToBeReplaced = Object.keys(this.options).map(function(file) {
    if (_this.nodeModules.indexOf(file) !== -1) {
      _this.dependencyMap[file] = path.resolve(
        compiler.context,
        _this.options[file]
      );
      return file;
    ...
    _this.dependencyMap[resolvedPath] = path.resolve(
      compiler.context,
      _this.options[file]
    );
    return resolvedPath;
  ...
  compiler.plugin('normal-module-factory', function(nmf) {
    nmf.plugin('before-resolve', function(module, callback) {
      if (module.context.includes(compiler.context)) {
        var nonNodeModuleIndex = _this.filesToBeReplaced.indexOf(
        ...
        if (nonNodeModuleIndex !== -1 || nodeModuleIndex !== -1) {
          var newFile = nonNodeModuleIndex !== -1
            ? path.resolve(module.context, module.request)
            : module.request;
